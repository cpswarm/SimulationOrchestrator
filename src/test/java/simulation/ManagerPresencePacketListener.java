 ...
 *
 */
public class ManagerPresencePacketListener implements StanzaListener {
	...
	/**
	 * Constructor of the {@link ManagerPresencePacketListener}
	 *
	 * @param xmppClient
	 ...
	 */
	public ManagerPresencePacketListener(final DummyManager manager,
